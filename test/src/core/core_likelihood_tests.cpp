...
//
//    auto d1 = std::make_shared<Data<GeneticsImpl>>("011010");
//    auto d2 = std::make_shared<Data<GeneticsImpl>>("101101");
//    auto k1 = std::make_shared<Parameter<GeneticsImpl>>("011010");
//    auto k2 = std::make_shared<Parameter<GeneticsImpl>>("101101");
//    std::cout << "Created Parameters" << std::endl;
//
//    auto ac1 = std::make_shared<AlleleCounter>(k1, d1);
//    auto ac2 = std::make_shared<AlleleCounter>(k2, d2);
//
//    auto acc = std::make_shared<AlleleCounterAccumulator>();
//    acc->addTarget(ac1);
//    acc->addTarget(ac2);
//
