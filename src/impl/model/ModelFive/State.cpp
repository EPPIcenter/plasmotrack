...
namespace transmission_nets::impl::ModelFive {
    State::State(const nlohmann::json& input) {
        ...
        obsFNRPriorAlpha = std::make_shared<core::parameters::Parameter<double>>(100);
        obsFNRPriorBeta = std::make_shared<core::parameters::Parameter<double>>(900);
        ...
        for (size_t _ = 0; _ < infections.size(); ++_) {
            ...
            observationFalseNegativeRates.emplace_back(new core::parameters::Parameter<double>(.1));
        }
