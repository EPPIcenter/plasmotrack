...
namespace transmission_nets::core::io {
    ...
    public:
        ...
        ParentSetDistLogger(std::shared_ptr<TransmissionProcessImpl> target, std::unique_ptr<Output> output);
    ...
    template<typename TransmissionProcessImpl>
    template<typename Output>
    ParentSetDistLogger<TransmissionProcessImpl>::ParentSetDistLogger(std::shared_ptr<TransmissionProcessImpl> target, std::unique_ptr<Output> output) : AbstractLogger(std::move(output)), target_(target) {}
