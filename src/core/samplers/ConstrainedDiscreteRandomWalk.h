...
public:
    ConstrainedDiscreteRandomWalk(Parameter<int> &parameter, T &target, Engine *rng)
    ...
    ConstrainedDiscreteRandomWalk(Parameter<int> &parameter, T &target, Engine *rng, unsigned int maxDistance)
