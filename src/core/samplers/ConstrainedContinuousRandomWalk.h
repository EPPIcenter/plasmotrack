...
public:
    ...
    ConstrainedContinuousRandomWalk(Parameter<double> &parameter, T &target, Engine *rng, double variance);

    ConstrainedContinuousRandomWalk(Parameter<double> &parameter, T &target, Engine *rng, double variance, double minVariance,
                                    double maxVariance);
...
template<int LOWER_BOUND, int UPPER_BOUND, typename T, typename Engine>
ConstrainedContinuousRandomWalk<LOWER_BOUND, UPPER_BOUND, T, Engine>::ConstrainedContinuousRandomWalk(Parameter<double> &parameter,
                                                                                                      T &target, Engine *rng)
