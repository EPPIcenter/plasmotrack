...
//    ParentSet<NodeValueImpl> sampleProposal() noexcept;
    ...
    RandomReverseEdgeSampler<MAX_PARENT_SET_CARDINALITY, T, Engine, NodeImpl>::RandomReverseEdgeSampler(parameters::TransmissionNetwork<NodeImpl> &network, T &target, Engine *rng) :
