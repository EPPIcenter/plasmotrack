...
namespace transmission_nets::core::samplers::topology {
    ...
    public:
        RandomReverseEdgeSampler(parameters::TransmissionNetwork<NodeValueImpl>& network, T& target, Engine* rng);
    ...
    RandomReverseEdgeSampler<MAX_PARENT_SET_CARDINALITY, T, Engine, NodeImpl>::RandomReverseEdgeSampler(parameters::TransmissionNetwork<NodeImpl>& network, T& target, Engine* rng) : network_(network), target_(target), rng_(rng) {
    ...
    template<int MAX_PARENT_SET_CARDINALITY, typename T, typename Engine, typename NodeValueImpl>
    float RandomReverseEdgeSampler<MAX_PARENT_SET_CARDINALITY, T, Engine, NodeValueImpl>::acceptanceRate() noexcept {
