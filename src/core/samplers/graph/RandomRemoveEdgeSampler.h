...
public:
    RandomRemoveEdgeSampler(TransmissionNetwork<NodeValueImpl> &network, T &target, Engine *rng);
...
RandomRemoveEdgeSampler<T, Engine, NodeImpl>::RandomRemoveEdgeSampler(TransmissionNetwork<NodeImpl> &network, T &target, Engine *rng) :
