...
public:
    DoubleConstrainedContinuousRandomWalk(Parameter<double> &parameter, T &target, double lower_bound, double upper_bound, Engine *rng);

    DoubleConstrainedContinuousRandomWalk(Parameter<double> &parameter, T &target,  double lower_bound, double upper_bound, Engine *rng, double variance);

    DoubleConstrainedContinuousRandomWalk(Parameter<double> &parameter, T &target, double lower_bound, double upper_bound, Engine *rng, double variance, double minVariance, double maxVariance);
...
template<typename T, typename Engine>
DoubleConstrainedContinuousRandomWalk<T, Engine>::DoubleConstrainedContinuousRandomWalk(Parameter<double> &parameter, T &target, double lower_bound, double upper_bound, Engine *rng)
        : ContinuousRandomWalk<T, Engine>(parameter, target, rng), lower_bound_(lower_bound), upper_bound_(upper_bound) {}


template<typename T, typename Engine>
DoubleConstrainedContinuousRandomWalk<T, Engine>::DoubleConstrainedContinuousRandomWalk(Parameter<double> &parameter,
